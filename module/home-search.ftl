					...
					data-aura-class="CoveoV2SearchUI CoveoV2CommunitySearchBox">
						...
						style="display: block;">
							...
							aria-haspopup="listbox">
								...
								role="button" aria-label="搜索" tabindex="0"></div>
								<#--  <div class="CoveoSearchButton coveo-accessible-button"
								role="button" aria-label="搜索" tabindex="0">
								...
								<div class="magic-box-input">
									...
									<input type="text" role="searchbox" form="coveo-dummy-form"
									aria-autocomplete="list" title="Insert a query. Press enter to send" aria-controls="coveo-magicbox-suggestions"
									aria-label="Submit search" placeholder="搜索关键字、产品或问题..">
