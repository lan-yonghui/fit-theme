    ...
    <form class="joe_header__above-search" method="get" id="myForm" name=”form” action="${blog_url!}/search">
        <div data-region-name="search">
            <div data-priority="" class="ui-widget">
                <div class="redesigned-searchbox searchbox-active cCommunitySearchboxExternal">
                    <div class="searchbox-wrapper">
                        ...
                        <div class="CoveoV2SearchUI CoveoV2CommunitySearchBox">
                            ...
                            style="display: block;">
                                ...
                                <div type="text" class="CoveoStandaloneSearchbox magic-box magic-box-inline CoveoOmnibox" aria-expanded="false" role="combobox" aria-owns="coveo-magicbox-suggestions"
                                aria-haspopup="listbox">
                                    <div class="coveo-field-value-suggestions">
                                    </div>
                                    <div class="CoveoSearchButton coveo-accessible-button"
                                    role="button" aria-label="Search" tabindex="0" onclick="formSubmit()">
